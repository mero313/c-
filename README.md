...
|---| ----- | -------- | ---------- |
|1946|[EXERCISES OF Binary search  ](1.O(log n) = log2​(128)=7
2.O(log n) = log2​(256)=8 )| [C#]
(./algorithms/cpp/largestNumberAfterMutatingSubstring/LargestNumberAfterMutatingSubstring.cpp), [Java](./algorithms/java/src/LargestNumberAfterMutatingSubtring/largestNumberAfterMutatingSubstring.java)|Medium|
